...
By default, Windows Terminal is preinstalled on Windows 11. If you're using Windows 10 and want to use this functionality, you can install Windows Terminal from the [Microsoft Store](https://apps.microsoft.com/detail/9n0dx20hk701).